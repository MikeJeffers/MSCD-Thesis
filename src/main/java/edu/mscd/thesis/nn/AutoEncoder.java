...
/**
 * AutoEncoder implementation using Encog by m4rkl1u
 * Source Repo: https://github.com/m4rkl1u/AutoEncoder
 * @author m4rkl1u
 *
 */
public class AutoEncoder {
	...
	private void buildNetwork() {
		...
		hiddenNet.addLayer(
				new BasicLayer(params.get(params.size() - 1).func, false, params.get(params.size() - 1).nodes));
