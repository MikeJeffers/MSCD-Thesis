...
public enum GeoType {
	WATER(Color.rgb(76, 112, 163), Density.NONE,new TileType[]{TileType.OCEAN}),
	...
	MED_DENSE(Color.rgb(242,0,0),Density.MED,  new TileType[]{TileType.BARREN, TileType.LAKE, TileType.FOREST}),
	...
	FOREST_DECIDUOUS(Color.rgb(107,173,102),Density.NONE,  new TileType[]{TileType.FOREST, TileType.HILL, TileType.RIVER}),
	...
	WETLAND_WOODY(Color.rgb(188,219,237),Density.NONE,  new TileType[]{TileType.DELTA, TileType.LAKE, TileType.RIVER}),
