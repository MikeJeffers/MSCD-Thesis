...
public enum TileType {
	...
	FOOTHILL("FootHills", true, true, Rules.MAX*0.25, Rules.MAX*0.2, Density.MED, new Color(0.5, 0.9, 0.2, 0.2)), 
	HILL("Hill", true, true, Rules.MAX*0.1, Rules.MAX*0.65, Density.HIGH, new Color(0.25, 0.6, 0.25, 0.2)), 
