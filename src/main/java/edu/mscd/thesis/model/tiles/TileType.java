...
public enum TileType {
	...
	POND("Pond", true, true, Rules.MAX*0.25, Rules.MAX*0.75, Density.VERYLOW, new Color(0, 0.1, 0.7, 0.2)), 
	STREAM("Stream", true, true, Rules.MAX*0.55, Rules.MAX*0.55, Density.MED, new Color(0, 0.25, 1.0, 0.2)),
	...
	WATER("Water", false, false, Rules.MAX*0.01, Rules.MAX, Density.NONE, new Color(0, 0.005, 1.0, 0.5));
